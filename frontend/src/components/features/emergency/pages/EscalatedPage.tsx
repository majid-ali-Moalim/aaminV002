        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-orange-100/80 mt-2 max-w-2xl">
              Pending cases delayed {ESCALATION_DELAY_MINUTES}+ minutes without crew assignment — immediate dispatch required.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 rounded-2xl border border-orange-200 bg-orange-50 p-5 shadow-sm">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm text-orange-800/80 mt-0.5">
              These incidents have been pending {ESCALATION_DELAY_MINUTES}+ minutes without assignment.
              Resource allocation is mandatory.
            </p>
          </div>
        </div>
      )}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-xl bg-orange-50 border border-orange-100 p-3">
                      <p className="text-xs text-orange-800 italic">
                        Escalated — pending {ESCALATION_DELAY_MINUTES}+ minutes without crew assignment.
                      </p>
                    </div>
                  </div>
