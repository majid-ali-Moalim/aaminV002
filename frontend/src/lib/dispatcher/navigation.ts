...
export const DISPATCHER_MODULES: NavModule[] = [
  ...
  {
    id: 'resources',
    label: 'Station Resources',
    icon: Truck,
    basePath: '/dispatcher/resources',
    description: 'Available ambulances, drivers, and nurses by station',
    defaultSlug: 'overview',
    standalone: true,
    items: [{ slug: 'overview', label: 'Station Resources', icon: Truck, exact: true }],
  },
  {
    id: 'hospital',
...
export const LEGACY_DISPATCHER_REDIRECTS: Record<string, string> = {
  ...
  '/dispatcher/fleet': '/dispatcher/resources',
  '/dispatcher/ambulances': '/dispatcher/resources',
  '/dispatcher/staff': '/dispatcher/resources',
  '/dispatcher/crew': '/dispatcher/resources',
  '/dispatcher/resources/ambulances': '/dispatcher/resources',
  '/dispatcher/resources/drivers': '/dispatcher/resources',
  '/dispatcher/resources/nurses': '/dispatcher/resources',
  '/dispatcher/resources/availability': '/dispatcher/resources',
  '/dispatcher/resources/ambulance-availability': '/dispatcher/resources',
  '/dispatcher/resources/driver-availability': '/dispatcher/resources',
  '/dispatcher/resources/nurse-availability': '/dispatcher/resources',
  '/dispatcher/resources/resource-status': '/dispatcher/resources',
  '/dispatcher/monitoring/resources': '/dispatcher/resources',
