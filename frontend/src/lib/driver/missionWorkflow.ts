...
export const DRIVER_TIMELINE_STEPS: DriverTimelineStep[] = [
  {
    ...
    label: 'Start Case',
    shortLabel: 'Start',
    description: 'Begin the run.',
    stepIds: ['ASSIGNED', 'ACCEPTED', 'EN_ROUTE_SCENE', 'ARRIVED_SCENE', 'EN_ROUTE_HOSPITAL'],
  },
  {
    id: 'COMPLETE',
    label: 'Case Complete',
    shortLabel: 'Done',
    description: 'Nurse completes notes and handover.',
    stepIds: ['ARRIVED_HOSPITAL', 'MISSION_COMPLETED'],
  },
]
